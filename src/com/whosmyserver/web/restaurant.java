...
public class restaurant {
	...
	public static String yelp(String url, String name) {
    ...
    nameValuePairs.add(new BasicNameValuePair("url",name));
    result = "0";
    // Download JSON data from URL
    try {
    	HttpClient httpclient = new DefaultHttpClient();
...
public static String Find(String url, String name) {
	...
	public static String GetbyZip(String url, String zip) {
