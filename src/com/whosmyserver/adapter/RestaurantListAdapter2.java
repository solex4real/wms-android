...
public class RestaurantListAdapter2 extends BaseAdapter{
    ...
    public RestaurantListAdapter2(Activity activity, List<Restaurant> restaurantItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView dis = (TextView) convertView.findViewById(R.id.status);
 
        // getting Restaurant data for the row
        Restaurant m = restaurantItems.get(position);
 
        // thumbnail image
        thumbNail.setImageUrl("http://bcminfo.bugs3.com/wms/api/images/"+m.getThumbnailUrl(), imageLoader);
     ...
     // address
        ...
        // release status
        dis.setText(String.valueOf(m.getStatus())+"mi");
	        return convertView;
	}
