...
import com.whosmyserver.adapter.RatingTabPagerAdapter;
import com.whosmyserver.adapter.TabPagerAdapter;
import com.whosmyserver.app.MainActivity;
import com.whosmyserver.app.R;

public class RatingFragment extends Fragment implements TabListener, OnPageChangeListener{
	private ViewPager viewPager;
	private RatingTabPagerAdapter mAdapter;
	private ActionBar actionBar;
	// Tab titles
	private String[] tabs = { "Pending", "Rated"};
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_rating, container,
				false);

		// Initilization
		viewPager = (ViewPager) rootView.findViewById(R.id.pager);
		actionBar = myContext.getActionBar();
		mAdapter = new RatingTabPagerAdapter(myContext.getSupportFragmentManager());
